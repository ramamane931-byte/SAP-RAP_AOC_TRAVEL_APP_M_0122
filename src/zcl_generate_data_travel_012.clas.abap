CLASS zcl_generate_data_travel_012 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_data_travel_012 IMPLEMENTATION.
...
*   clear data
    DELETE FROM ztbl_trav_012.
    DELETE FROM ztbl_dtrav_012.

    "insert travel demo data
    INSERT ztbl_trav_012  FROM (
        SELECT
