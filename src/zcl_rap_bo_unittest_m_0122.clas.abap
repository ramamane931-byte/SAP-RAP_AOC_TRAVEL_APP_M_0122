"! @testing BDEF:ZI_R_TRAVEL_M_0122
CLASS zcl_rap_bo_unittest_m_0122 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC
FOR TESTING
...
CLASS zcl_rap_bo_unittest_m_0122 IMPLEMENTATION.
  ...
  METHOD class_setup.
    ...
    cds_test_environment = cl_cds_test_environment=>create_for_multiple_cds(
                      i_for_entities = VALUE #(
                        ( i_for_entity = 'ZI_R_TRAVEL_M_0122' ) ) ).
  ...
  METHOD create_with_action.
    ...
    MODIFY ENTITIES OF zi_r_travel_m_0122
     ENTITY Travel
    ...
    " execute action `deductDiscount`
     ENTITY Travel
       EXECUTE deductDiscount
         FROM VALUE #( ( %cid_ref = 'ROOT1'
                         %param-discount_percentage = '20' ) )   "=> 20%
    ...
    SELECT * FROM zi_r_travel_m_0122 INTO TABLE @DATA(lt_travel). "#EC CI_NOWHERE
