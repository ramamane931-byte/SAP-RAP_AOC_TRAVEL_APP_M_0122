...
define view entity zc_bookingsuppl_m_0122
  as projection on zi_bookingsuppl_m_0122
{
  key TravelId,
  key BookingId,
  key BookingSupplementId,
      ...
      /* Associations */
      _Booking : redirected to parent ZC_BOOKING_M_0122,
      _Supplement,
      _SupplementText,
      _Travel  : redirected to ZC_R_TRAVEL_M_0122
}
