...
define view entity zi_bookingsuppl_m_0122
  as select from /dmo/booksuppl_m
  association        to parent zi_booking_m_0122 as _Booking        on  $projection.TravelId  = _Booking.TravelId
                                                                    and $projection.BookingId = _Booking.BookingId
  association [1..1] to zi_r_travel_m_0122       as _Travel         on  $projection.TravelId = _Travel.TravelId
