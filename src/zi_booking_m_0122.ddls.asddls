...
define view entity zi_booking_m_0122
  as select from /dmo/booking_m
  composition [0..*] of zi_bookingsuppl_m_0122       as _BookingSuppl
  association        to parent zi_r_travel_m_0122           as _Travel on  $projection.TravelId = _Travel.TravelId
